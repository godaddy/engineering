...
It’s an open source project written in Java, [Apache Oozie](https://github.com/apache/Oozie).
...
It’s an open source project written in python, [Apache Airflow](https://github.com/apache/incubator-airflow).
